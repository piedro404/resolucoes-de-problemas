SELECT
    ...
    ROUND(AVG(salario_liquido), 2) AS "Media Salarial",
    ROUND(MAX(salario.salario_liquido), 2) AS "Maior Salario",
    CASE
        WHEN MIN(salario.salario_liquido) = 0 THEN '0'
        ELSE ROUND(MIN(salario.salario_liquido), 2)
